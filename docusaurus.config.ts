    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/NinjaWskarpetach/BlenderAddon',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/NinjaWskarpetach/BlenderAddon',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Titan-Forge, Inc. Built with Docusaurus.`,
    },
    prism: {
